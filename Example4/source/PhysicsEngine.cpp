...
physx::PxJoint *PhysicsEngine::CreateFixedJoint(PhysicsEngine::FixedJointDesc desc) {
	physx::PxFixedJoint *joint = physx::PxFixedJointCreate(*physics, desc.actor0, desc.transform0, desc.actor1, desc.transform1);
	joint->setConstraintFlag(physx::PxConstraintFlag::eCOLLISION_ENABLED, desc.collisionEnabled);
#ifdef USE_PVD
	joint->setConstraintFlag(physx::PxConstraintFlag::eVISUALIZATION, desc.visualizationEnabled);
#endif
	if (desc.isBreakable) {
		joint->setBreakForce(desc.forceThreshold, desc.torqueThreshold);
	}
	return joint;
}

physx::PxJoint *PhysicsEngine::CreateSphericalJoint(PhysicsEngine::SphericalJointDesc desc) {
	physx::PxSphericalJoint *joint = physx::PxSphericalJointCreate(*physics, desc.actor0, desc.transform0, desc.actor1, desc.transform1);
	joint->setConstraintFlag(physx::PxConstraintFlag::eCOLLISION_ENABLED, desc.collisionEnabled);
#ifdef USE_PVD
	joint->setConstraintFlag(physx::PxConstraintFlag::eVISUALIZATION, desc.visualizationEnabled);
#endif
	...
	if (desc.limitEnabled) {
		joint->setLimitCone(physx::PxJointLimitCone(desc.yLimitAngle, desc.zLimitAngle));
		joint->setSphericalJointFlag(physx::PxSphericalJointFlag::eLIMIT_ENABLED, true);
	}
	return joint;
}

physx::PxJoint *PhysicsEngine::CreateRevoluteJoint(PhysicsEngine::RevoluteJointDesc desc) {
	physx::PxRevoluteJoint *joint = physx::PxRevoluteJointCreate(*physics, desc.actor0, desc.transform0, desc.actor1, desc.transform1);
	joint->setConstraintFlag(physx::PxConstraintFlag::eCOLLISION_ENABLED, desc.collisionEnabled);
#ifdef USE_PVD
	joint->setConstraintFlag(physx::PxConstraintFlag::eVISUALIZATION, desc.visualizationEnabled);
#endif
	...
	if (desc.limitEnabled) {
		joint->setLimit(physx::PxJointAngularLimitPair(desc.lowerLimit, desc.upperLimit));
		joint->setRevoluteJointFlag(physx::PxRevoluteJointFlag::eLIMIT_ENABLED, true);
	}
	return joint;
}

physx::PxJoint *PhysicsEngine::CreatePrismaticJoint(PhysicsEngine::PrismaticJointDesc desc) {
	physx::PxPrismaticJoint *joint = physx::PxPrismaticJointCreate(*physics, desc.actor0, desc.transform0, desc.actor1, desc.transform1);
	joint->setConstraintFlag(physx::PxConstraintFlag::eCOLLISION_ENABLED, desc.collisionEnabled);
#ifdef USE_PVD
	joint->setConstraintFlag(physx::PxConstraintFlag::eVISUALIZATION, desc.visualizationEnabled);
#endif
	...
	if (desc.limitEnabled) {
		joint->setLimit(physx::PxJointLinearLimitPair(physics->getTolerancesScale(), desc.lowerLimit, desc.upperLimit));
		joint->setPrismaticJointFlag(physx::PxPrismaticJointFlag::eLIMIT_ENABLED, true);
	}
	return joint;
}

physx::PxJoint *PhysicsEngine::CreateDistanceJoint(PhysicsEngine::DistanceJointDesc desc) {
	physx::PxDistanceJoint *joint = physx::PxDistanceJointCreate(*physics, desc.actor0, desc.transform0, desc.actor1, desc.transform1);
	joint->setConstraintFlag(physx::PxConstraintFlag::eCOLLISION_ENABLED, desc.collisionEnabled);
#ifdef USE_PVD
	joint->setConstraintFlag(physx::PxConstraintFlag::eVISUALIZATION, desc.visualizationEnabled);
#endif
	...
	if (desc.minDistanceEnabled) {
		joint->setMinDistance(desc.minDistance);
		joint->setDistanceJointFlag(physx::PxDistanceJointFlag::eMIN_DISTANCE_ENABLED, true);
	}
	if (desc.maxDistanceEnabled) {
		joint->setMaxDistance(desc.maxDistance);
		joint->setDistanceJointFlag(physx::PxDistanceJointFlag::eMAX_DISTANCE_ENABLED, true);
	}
	return joint;
}

physx::PxJoint *PhysicsEngine::CreateD6Joint(PhysicsEngine::D6JointDesc desc) {
	physx::PxD6Joint *joint = physx::PxD6JointCreate(*physics, desc.actor0, desc.transform0, desc.actor1, desc.transform1);
	joint->setAngularDriveConfig(physx::PxD6AngularDriveConfig::eSWING_TWIST);
	joint->setConstraintFlag(physx::PxConstraintFlag::eCOLLISION_ENABLED, desc.collisionEnabled);
#ifdef USE_PVD
	joint->setConstraintFlag(physx::PxConstraintFlag::eVISUALIZATION, desc.visualizationEnabled);
#endif
	...
	joint->setMotion(physx::PxD6Axis::eX, desc.motions[physx::PxD6Axis::eX]);
	joint->setMotion(physx::PxD6Axis::eY, desc.motions[physx::PxD6Axis::eY]);
	joint->setMotion(physx::PxD6Axis::eZ, desc.motions[physx::PxD6Axis::eZ]);
	joint->setMotion(physx::PxD6Axis::eTWIST, desc.motions[physx::PxD6Axis::eTWIST]);
	joint->setMotion(physx::PxD6Axis::eSWING1, desc.motions[physx::PxD6Axis::eSWING1]);
	joint->setMotion(physx::PxD6Axis::eSWING2, desc.motions[physx::PxD6Axis::eSWING2]);
	if (desc.motions[physx::PxD6Axis::eX] == physx::PxD6Motion::eLIMITED) {
		joint->setLinearLimit(physx::PxD6Axis::eX, physx::PxJointLinearLimitPair(physics->getTolerancesScale(), desc.xLowerLimit, desc.xUpperLimit));
	}
	if (desc.motions[physx::PxD6Axis::eY] == physx::PxD6Motion::eLIMITED) {
		joint->setLinearLimit(physx::PxD6Axis::eY, physx::PxJointLinearLimitPair(physics->getTolerancesScale(), desc.yLowerLimit, desc.yUpperLimit));
	}
	if (desc.motions[physx::PxD6Axis::eZ] == physx::PxD6Motion::eLIMITED) {
		joint->setLinearLimit(physx::PxD6Axis::eZ, physx::PxJointLinearLimitPair(physics->getTolerancesScale(), desc.zLowerLimit, desc.zUpperLimit));
	}
	if (desc.motions[physx::PxD6Axis::eTWIST] == physx::PxD6Motion::eLIMITED) {
		joint->setTwistLimit(physx::PxJointAngularLimitPair(desc.twistLowerLimit, desc.twistUpperLimit));
	}
	if (desc.motions[physx::PxD6Axis::eSWING1] == physx::PxD6Motion::eLIMITED || desc.motions[physx::PxD6Axis::eSWING2] == physx::PxD6Motion::eLIMITED) {
		joint->setSwingLimit(physx::PxJointLimitCone(desc.yLimitAngle, desc.zLimitAngle));
	}
